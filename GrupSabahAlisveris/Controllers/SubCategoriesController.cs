...
namespace GrupSabahAlisveris.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubCategory_Id,SubCategory_Name,Category_Id")] SubCategory subCategory)
        {
            ...
            ViewData["Category_Id"] = new SelectList(_context.Categories, "Category_Id", "Category_Name", subCategory.Category_Id);
            return View(subCategory);
        }
        ...
        {
          return (_context.SubCategories?.Any(e => e.SubCategory_Id == id)).GetValueOrDefault();
        }
    }
}
